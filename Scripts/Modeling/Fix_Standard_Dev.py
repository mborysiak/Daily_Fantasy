...
# cut=False
# if cut:
#     corr_data_high_qb_teams = corr_data[corr_data.pos_rank=='QB0']
#     corr_data_high_qb_teams = corr_data_high_qb_teams.loc[(corr_data_high_qb_teams.max_metric <= \
#                                                         np.percentile(corr_data_high_qb_teams.max_metric, 50)), 
#                                                         ['team', 'week', 'year']]
#     corr_data_high_qb = pd.merge(corr_data, corr_data_high_qb_teams, on=['team', 'week','year'])

#     cor_matrix = corr_data_high_qb.pivot_table(index=['team', 'week', 'year'], columns='pos_rank', values='y_act').fillna(0)
# else: 
#     cor_matrix = corr_data.pivot_table(index=['team', 'week', 'year'], columns='pos_rank', values='y_act').fillna(0)
...
# xx.plot.scatter(x='Aaron Rodgers', y='Davante Adams')
