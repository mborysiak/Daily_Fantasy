    ...
    for repeat_num in range(10):
        ...
        for week, year in zip(set_weeks, set_years):
            ...
            d = {'adjust_pos_counts': {False: 0.6, True: 0.4},
                ...
                'num_avg_pts': {1: 0.0, 2: 0.0, 3: 0.0, 5: 0, 7: 0.5, 10: 0.5},
                'num_iters': {50: 0, 100: 0.0, 150: 1},
                ...
                'qb_min_iter': {0: 0.6, 2: 0.4, 4: 0, 9: 0.0},
                ...
                'top_n_choices': {0: 1, 1: 0, 2: 0},
                'use_ownership': {0.8: 1, 0.9: 0.0, 1: 0}}
